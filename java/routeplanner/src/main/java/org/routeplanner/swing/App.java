...
import org.routeplanner.service.impl.RouteManagerFloydWarshall;
...
public class App implements Runnable {
	...
	public App() throws IOException {
		...
		feeder.loadLinks(rb.getString("application.links") );
	}
	...
	public void run() {
		...
		String appTitle=rb.getString("application.name") +
				" (Version "+rb.getString("application.version")+")";
		
		MainDialog mp = new MainDialog( appTitle, countries );
