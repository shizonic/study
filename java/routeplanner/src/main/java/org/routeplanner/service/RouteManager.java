...
public interface RouteManager {
	 ...
	 * @return routes
	 */
	Link[] findAllLinks(City[] cities);
	
	/**
	 * find shortest path from source to target city
	...
	/**
	 * find all cities that lie within the rectangle
	 * defined by the diagonal of 2 cities
	 * @param from city
	 * @param to city
