...
class CountryTableMap extends TableMap
{
     ...
     */
    const COL_PROVINCE = 'Country.Province';

    /**
     * the column name for the Area field
     */
    const COL_AREA = 'Country.Area';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Name', 'Code', 'Capital', 'Province', 'Area', 'Population', ),
        self::TYPE_CAMELNAME     => array('name', 'code', 'capital', 'province', 'area', 'population', ),
        self::TYPE_COLNAME       => array(CountryTableMap::COL_NAME, CountryTableMap::COL_CODE, CountryTableMap::COL_CAPITAL, CountryTableMap::COL_PROVINCE, CountryTableMap::COL_AREA, CountryTableMap::COL_POPULATION, ),
        self::TYPE_FIELDNAME     => array('Name', 'Code', 'Capital', 'Province', 'Area', 'Population', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Name' => 0, 'Code' => 1, 'Capital' => 2, 'Province' => 3, 'Area' => 4, 'Population' => 5, ),
        self::TYPE_CAMELNAME     => array('name' => 0, 'code' => 1, 'capital' => 2, 'province' => 3, 'area' => 4, 'population' => 5, ),
        self::TYPE_COLNAME       => array(CountryTableMap::COL_NAME => 0, CountryTableMap::COL_CODE => 1, CountryTableMap::COL_CAPITAL => 2, CountryTableMap::COL_PROVINCE => 3, CountryTableMap::COL_AREA => 4, CountryTableMap::COL_POPULATION => 5, ),
        self::TYPE_FIELDNAME     => array('Name' => 0, 'Code' => 1, 'Capital' => 2, 'Province' => 3, 'Area' => 4, 'Population' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addColumn('Name', 'Name', 'VARCHAR', true, 35, null);
        $this->addPrimaryKey('Code', 'Code', 'VARCHAR', true, 4, '');
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return null === $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CountryTableMap::COL_PROVINCE);
            $criteria->addSelectColumn(CountryTableMap::COL_AREA);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CountryTableMap::COL_CODE, (array) $values, Criteria::IN);
        }
