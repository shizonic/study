 ...
 * @method     ChildCountryQuery orderByProvince($order = Criteria::ASC) Order by the Province column
 * @method     ChildCountryQuery orderByArea($order = Criteria::ASC) Order by the Area column
 ...
 * @method     ChildCountryQuery groupByProvince() Group by the Province column
 * @method     ChildCountryQuery groupByArea() Group by the Area column
 ...
 * @method     ChildCountry findOneByProvince(string $Province) Return the first ChildCountry filtered by the Province column
 * @method     ChildCountry findOneByArea(double $Area) Return the first ChildCountry filtered by the Area column
 ...
 * @method     ChildCountry requireOneByProvince(string $Province) Return the first ChildCountry filtered by the Province column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 * @method     ChildCountry requireOneByArea(double $Area) Return the first ChildCountry filtered by the Area column and throws \Propel\Runtime\Exception\EntityNotFoundException when not found
 ...
 * @method     ChildCountry[]|ObjectCollection findByProvince(string $Province) Return ChildCountry objects filtered by the Province column
 * @method     ChildCountry[]|ObjectCollection findByArea(double $Area) Return ChildCountry objects filtered by the Area column
...
abstract class CountryQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT Name, Code, Capital, Province, Area, Population FROM Country WHERE Code = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(CountryTableMap::COL_CODE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(CountryTableMap::COL_CODE, $keys, Criteria::IN);
    }
    ...
    public function filterByProvince($province = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(CountryTableMap::COL_PROVINCE, $province, $comparison);
    }
    ...
    public function filterByArea($area = null, $comparison = null)
    {
        if (is_array($area)) {
            $useMinMax = false;
            if (isset($area['min'])) {
                $this->addUsingAlias(CountryTableMap::COL_AREA, $area['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($area['max'])) {
                $this->addUsingAlias(CountryTableMap::COL_AREA, $area['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CountryTableMap::COL_AREA, $area, $comparison);
    }
