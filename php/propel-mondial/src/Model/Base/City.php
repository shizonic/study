...
abstract class City implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Model\\Map\\CityTableMap';
    ...
    /**
     * Initializes internal state of Model\Base\City object.
     * @see applyDefaults()
     */
     ...
     * @return $this|\Model\City The current object (for fluent API support)
     */
    ...
    public function setCountry($v)
    {
        ...
        if ($this->country !== $v) {
            $this->country = $v;
            $this->modifiedColumns[CityTableMap::COL_COUNTRY] = true;
        }
    ...
    public function setProvince($v)
    {
        ...
        if ($this->province !== $v) {
            $this->province = $v;
            $this->modifiedColumns[CityTableMap::COL_PROVINCE] = true;
        }
    ...
    public function setPopulation($v)
    {
        ...
        if ($this->population !== $v) {
            $this->population = $v;
            $this->modifiedColumns[CityTableMap::COL_POPULATION] = true;
        }
    ...
    public function setLongitude($v)
    {
        ...
        if ($this->longitude !== $v) {
            $this->longitude = $v;
            $this->modifiedColumns[CityTableMap::COL_LONGITUDE] = true;
        }
    ...
    public function setLatitude($v)
    {
        ...
        if ($this->latitude !== $v) {
            $this->latitude = $v;
            $this->modifiedColumns[CityTableMap::COL_LATITUDE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CityTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CityTableMap::translateFieldName('Country', TableMap::TYPE_PHPNAME, $indexType)];
            $this->country = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CityTableMap::translateFieldName('Province', TableMap::TYPE_PHPNAME, $indexType)];
            $this->province = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CityTableMap::translateFieldName('Population', TableMap::TYPE_PHPNAME, $indexType)];
            $this->population = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CityTableMap::translateFieldName('Longitude', TableMap::TYPE_PHPNAME, $indexType)];
            $this->longitude = (null !== $col) ? (double) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CityTableMap::translateFieldName('Latitude', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Model\\City'), 0, $e);
        }
    }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CityTableMap::COL_COUNTRY)) {
            $modifiedColumns[':p' . $index++]  = 'Country';
        }
        if ($this->isColumnModified(CityTableMap::COL_PROVINCE)) {
            $modifiedColumns[':p' . $index++]  = 'Province';
        }
        if ($this->isColumnModified(CityTableMap::COL_POPULATION)) {
            $modifiedColumns[':p' . $index++]  = 'Population';
        }
        if ($this->isColumnModified(CityTableMap::COL_LONGITUDE)) {
            $modifiedColumns[':p' . $index++]  = 'Longitude';
        }
        if ($this->isColumnModified(CityTableMap::COL_LATITUDE)) {
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Model\City The current object, for fluid interface
     */
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CityTableMap::COL_COUNTRY)) {
            $criteria->add(CityTableMap::COL_COUNTRY, $this->country);
        }
        if ($this->isColumnModified(CityTableMap::COL_PROVINCE)) {
            $criteria->add(CityTableMap::COL_PROVINCE, $this->province);
        }
        if ($this->isColumnModified(CityTableMap::COL_POPULATION)) {
            $criteria->add(CityTableMap::COL_POPULATION, $this->population);
        }
        if ($this->isColumnModified(CityTableMap::COL_LONGITUDE)) {
            $criteria->add(CityTableMap::COL_LONGITUDE, $this->longitude);
        }
        if ($this->isColumnModified(CityTableMap::COL_LATITUDE)) {
            $criteria->add(CityTableMap::COL_LATITUDE, $this->latitude);
        }
    ...
    {
        return (null === $this->getName()) && (null === $this->getCountry()) && (null === $this->getProvince());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Model\City (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Model\City Clone of current object.
     * @throws PropelException
     */
